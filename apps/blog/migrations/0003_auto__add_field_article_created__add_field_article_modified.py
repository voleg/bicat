...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('blog_article', 'created')

        # Deleting field 'Article.modified'
        db.delete_column('blog_article', 'modified')
    ...
    models = {
        ...
        'blog.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.TextField', [], {'max_length': '20480', 'null': 'True', 'blank': 'True'}),
        ...
        'blog.category': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_set'", 'to': "orm['auth.User']"}),
